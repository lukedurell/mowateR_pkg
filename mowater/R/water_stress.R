...
#' legend("topright", c("SWE", "DNK", "FIN", "ISL"), 
#' col = cols, pch = "l", bg = "white")
#'
#'  library(maps)
#' library(viridis)
#'
#' country.names <- maps::map('world', names=TRUE, plot=FALSE)
...
#'
#' n.col <- 10
#' mycolors <- (viridis::viridis(10))[n.col:1]
...
#'
#' maps::map(database = "world", names = TRUE, fill = TRUE, col = thecolors)
#' legend('left', legend=levels(ind), 2, fill = mycolors,
#' cex = 1.2, bty = "n")
